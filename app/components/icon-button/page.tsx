...
export default function IconButtonPage() {
  return (
    <div>
      {/* ── Page header ── */}
      <PageHeader
        breadcrumb={['Components', 'Form', 'IconButton']}
        title="IconButton"
        description="Icon-only button with tooltip, badge, toggle and FAB support. 6 variants, 5 sizes."
        tags={['6 variants', '5 sizes', 'Toggle', 'Badge', 'Tooltip', 'FAB', 'Loading']}
      />
