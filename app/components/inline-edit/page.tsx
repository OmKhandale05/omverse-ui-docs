...
const BASIC=`import { InlineEdit } from 'omverse-ui'
...
<ComponentDocSection id="when-to-use" title="When to use" description="Use for familiar properties that can be changed safely and understood in place."><GuidanceList tone="do" items={[{title:'Edit a single property',description:'Update names, labels, owners, or concise descriptions.'},{title:'Preserve context',description:'Keep related records and consequences visible.'},{title:'Support fast review',description:'Make frequent low-risk corrections without navigation.'}]}/></ComponentDocSection>
<ComponentDocSection id="when-not-to-use" title="When not to use" description="Use a form surface when editing needs several fields, complex guidance, or confirmation."><GuidanceList tone="dont" items={[{title:'Do not edit dependent fields',description:'Use SidePanel or Dialog for coordinated inputs.'},{title:'Do not hide high-risk changes',description:'Use an explicit confirmation workflow.'},{title:'Do not edit rich content',description:'Use a dedicated editor for formatting and attachments.'}]}/></ComponentDocSection>
<ComponentDocSection id="variants" title="Variants" description="Container treatment, size, and editor type adapt InlineEdit to tables, details panels, and descriptions."><BehaviorGrid items={[{icon:'ti-line-dashed',title:'Plain',description:'Integrates into an existing details surface.'},{icon:'ti-border-all',title:'Outlined',description:'Defines the complete editable region.'},{icon:'ti-square-filled',title:'Tonal',description:'Distinguishes editable metadata.'},{icon:'ti-align-left',title:'Multiline',description:'Supports short paragraph content.'}]}/></ComponentDocSection>
<ComponentDocSection id="states" title="States" description="Committed and draft values remain separate until validation succeeds."><StateMatrix rows={[{state:'Display',trigger:'Not editing',visual:'Committed value and revealed edit affordance',interaction:'Activate to edit'},{state:'Editing',trigger:'Edit begins',visual:'Focused field and actions',interaction:'Draft changes only'},{state:'Invalid',trigger:'Validation fails',visual:'Error border and message',interaction:'Correct or cancel'},{state:'Saving',trigger:'Async persistence',visual:'Progress in save control',interaction:'Actions disabled'},{state:'Empty',trigger:'No committed value',visual:'Add a value prompt',interaction:'Activate to create'},{state:'Disabled',trigger:'Editing unavailable',visual:'Reduced emphasis',interaction:'Cannot enter edit mode'}]}/></ComponentDocSection>
