...
export default function IconPage() {
  ...
  return (
    <div>
      {/* ── Page header ── */}
      <PageHeader
        breadcrumb={['Components', 'Display', 'Icon']}
        title="Icon"
        description="Lucide icons wrapped in a consistent Icon component. Every component in omverse-ui uses this — swap the underlying source in one file."
        tags={['38 icons', 'Lucide', 'Searchable', '4 sizes', 'Filled state']}
      />
