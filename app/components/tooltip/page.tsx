...
export default function TooltipPage() {
  return (
    <div>
      {/* ── Page header ── */}
      <PageHeader
        breadcrumb={['Components', 'Feedback', 'Tooltip']}
        title="Tooltip"
        description="Contextual information shown on hover and focus. Supports 4 positions, 3 variants, keyboard shortcuts and rich content."
        tags={['4 positions', '3 variants', 'Keyboard shortcut', 'Rich content', 'Works on disabled']}
      />
