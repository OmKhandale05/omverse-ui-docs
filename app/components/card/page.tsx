    ...
    <div>
      ...
      <ComponentDocumentation>
        ...
        <ComponentDocSection id="anatomy" title="Anatomy" description="A card surface can contain media, a header, body content, and a footer, but only the regions needed by the content should be rendered.">
          <Anatomy preview={<div className="component-anatomy-visual" style={{ width: 260 }}><Card variant="outlined"><CardMedia height={72}><span style={{ opacity: .65 }}>Media</span></CardMedia><CardHeader title="Project title" subtitle="Supporting context" /><CardBody>Primary content</CardBody><CardFooter divider>Actions</CardFooter></Card><span className="component-anatomy-marker component-anatomy-marker--leader-right" style={{ top: 24, left: -34 }}>1</span><span className="component-anatomy-marker component-anatomy-marker--leader-left" style={{ top: 92, right: -34 }}>2</span><span className="component-anatomy-marker component-anatomy-marker--leader-right" style={{ top: 154, left: -34 }}>3</span><span className="component-anatomy-marker component-anatomy-marker--leader-left" style={{ bottom: 20, right: -34 }}>4</span></div>} items={[
